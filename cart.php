    ...
    <div class="container">
        <div class="breadcrumbs">
            <ol class="breadcrumb">
                ...
                <li class="active">Pannier client</li>
            </ol>
        </div>
             ...
             ';
                    ...
                    <td class="input-group custom-search-form">
                        <input type="hidden" maxlength="3" class="form-control input-sm" autocomplete="off"
                            ...
                            value="<?php echo $result->PROQTY; ?>" placeholder="Recherche...">
                        ...
                        <input type="number" maxlength="3" data-id="<?php echo $result->PROID;  ?>"
                            ...
                            name="QTY<?php echo $result->PROID; ?>"
                            value="<?php echo $_SESSION['gcCart'][$i]['qty']; ?>" placeholder="Recherche...">
