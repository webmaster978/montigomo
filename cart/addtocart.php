...
if (isset($_POST['updateid'])) {
  ...
  for ($i = 0; $i < $max; $i++) {
    ...
    $price = (float)(isset($_GET['subTOT' . $pid]) ? $_GET['subTOT' . $_POST['updateid']] : "");
                      ...
                      WHERE  p.`CATEGORYID`=c.`CATEGORYID` and PRODUCTID='" . $_SESSION['fixnmix_cart'][$i]['productid'] . "'";
                        ...
                        ?>
                                                <tr>
                                                    ...
                                                    <td><input type="NUMBER"
                                                            data-id="<?php echo $result->PRODUCTID;  ?>" class="cusqty"
                                                            name="QTY<?php echo $result->PRODUCTID;  ?>"
                                                            id="QTY<?php echo $result->PRODUCTID; ?>"
                                                    ...
                                                    <input type="hidden"
                                                        name="originalPRICE<?php echo $result->PRODUCTID;  ?>"
                                                        id="originalPRICE<?php echo $result->PRODUCTID; ?>"
                                                        value="<?php echo  $result->PRICE ?>" /></td>
                                                    <input type="hidden"
                                                        name="originalqty<?php echo $result->PRODUCTID;  ?>"
                                                        id="originalqty<?php echo $result->PRODUCTID; ?>"
                                                        value="<?php echo  $result->QTY ?>" /></td>

                                                    <!-- end -->
                                                    <td> <a href="cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>"
                                                            data-id="<?php echo $result->PRODUCTID ?>"
                                                            class="delete btn btn-danger btn-xs">Supprimer</a></td>
                                                </tr>
                                                <?php
                            }
                          }
                        ...
                        ?>
                                    ...
                                    <table>
                                        <tfoot>
                                            <strong>
                                                <h1 align="right">Prix total : $ <span style="margin-right:3%"
                                                        id="sum">0.00</span></h1>
                                            </strong></td>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="modal-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="user_pass2" id="user_pass2" placeholder="Password"
                        ...
                        <div class="tab-pane" id="settings"><br /><br />
                            <form class="form-horizontal span6" action="customer/controller.php?action=add"
                                onsubmit="return  validatecustomer()" name="personal" method="POST"
                ...
                ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control input-sm" id="LASTNAME" name="LASTNAME"
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <label class="col-md-4 control-label" for="HOMENUMBER">Home
                                                    Number:</label>

                                                <div class="col-md-8">
                                                    <input class="form-control input-sm" id="HOMENUMBER"
                                                        name="HOMENUMBER" placeholder="Home Number" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <label class="col-md-4 control-label" for="STREET">Street / Village
                                                    :</label>

                                                <div class="col-md-8">
                                                    <input class="form-control input-sm" id="STREET" name="STREET"
                                                        placeholder="Street" type="text" value="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control input-sm" id="BARANGGY" name="BARANGGY"
                                                        placeholder="Barangay" type="text" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control input-sm" id="CITYADDRESS"
                                                        name="CITYADDRESS" placeholder="City Address" type="text"
                                                        value="">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            "Email Address" type="text" value="">
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-8">
                                            <p>Note</p>
                                            Password must be atleast 8 to 15 characters. Only letter, numeric digits,
                                            ...
                                            <p>
                                                ...
                                                <small>Agree the <a class="toggle-modal"
                                                        onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"><b>TERMS
                                                            AND CONDITION</b></a> of this Bakeshop</small>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="savecustomer" class="submit btn btn_fixnmix">Sign
                                        Up</button>
