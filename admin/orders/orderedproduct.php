...
<div class="modal-dialog" style="width:70%">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2>FACTURE NUMERO : <?php echo $_SESSION['ordernumber']; ?></h2>
        ...
        <div class="row" style="margin:2%">
            <div class="col-md-6">NOM DE L'AGENT : <?php echo $cur->FNAME . ' ' .  $cur->LNAME; ?></div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 pull-left">
                        <div>Date Vente : <?php echo date_format(date_create($cur->ORDEREDDATE), "M/d/Y h:i:s"); ?>
                        </div>
