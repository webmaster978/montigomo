     ...
     <div class="">
         <div class="panel panel-default">
             <div class="panel-body">
                 <fieldset>
                     <legend>
                         <h2 class="text-left">Autre detail</h2>
                     </legend>
                     ...
                     <table class="fixnmix-table">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td width="350px"> <input id="CONTACTNUMBER" name="CONTACTNUMBER"
                                         class="form-control input-sm" type="number"
                                         value="<?php echo isset($_SESSION['CONTACTNUMBER']) ? $_SESSION['CONTACTNUMBER'] : ""; ?>">
                                 </td>
                             </tr>
                         </tbody>
                         <tfoot>
             ...
             <div class="container">
                 <div class="row">
                     <h3 align="right" margin-right="20%">Total Price : $ <span id="sum">0.00</span></h3>
                 </div>
             </div>
        ...
        ?>
             ...
             <a href="index.php?view=addtocart" class="btn btn-default"><span
                     class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Voir le panier</strong></a>
