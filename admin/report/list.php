            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group input-group" style="margin-top:25px;">
                        <button class="btn btn-primary btn-sm" name="submit" type="submit">Filtrer <i
    ...
    <span id="printout">
        <div class="col-md-12">
            <div class="page-header" style="text-align:center;">
                <h1>List des ventes</h1>
                <div>Dates: de :
                    <?php echo isset($_POST['date_pickerfrom']) ? $_POST['date_pickerfrom'] : ''; ?> - à :
...
";
							...
							if (!isset($cus)) {
								...
								echo '<tr><td colspan="7" align="center"><h2>Entrer les dates</h2></td></tr>';
							}
						} else {
							echo '<tr><td colspan="7" align="center"><h2>Entrer les dates</h2></td></tr>';
						}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-2">
                <button onclick="tablePrint();" class="btn btn-primary"><i class="fa fa-print"></i> IMPRIMER</button>
            </div>
        </div>
    </div>
</div>
...
function tablePrint() {
    ...
    document_print.document.write(
        '<body style="font-family:Calibri(body);  font-size:8px;" onLoad="self.print();self.close();" >');
