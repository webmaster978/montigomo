...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Modifier categorie</h1>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <input class="form-control input-sm" id="CATEGORY" name="CATEGORY" placeholder="Categorie" type="text"
                    value="<?php echo $singlecategory->CATEGORIES; ?>">
            </div>
        </div>
    </div>
