...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Modifier les produits</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<div class="row">
    ...
    <div class="form-group">
        <div class="col-md-8">
            <label class="col-md-4 control-label" for="OWNERNAME">Nom du produit:</label>

            <div class="col-md-8">
                <input class="form-control input-sm" id="OWNERNAME" name="OWNERNAME" placeholder="nom produits"
                    type="text" value="<?php echo $singleproduct->OWNERNAME; ?>">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="OWNERPHONE" name="OWNERPHONE" placeholder="ex: 0000000000"
                    type="number" value="<?php echo $singleproduct->OWNERPHONE; ?>">
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <select class="form-control input-sm" name="CATEGORY" id="CATEGORY">
                    <option value="None">Selectionner une categorie</option>
                    <?php
          //Statement
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-3">
                <input class="form-control input-sm" id="ORIGINALPRICE" name="ORIGINALPRICE"
                    placeholder="Prix originale" type="number" value="<?php echo $singleproduct->ORIGINALPRICE; ?>">
            </div>
            <label class="col-md-2 control-label" for="PROPRICE">Prix:</label>

            <div class="col-md-3">
                <input class="form-control input-sm" id="PROPRICE" name="PROPRICE" placeholder="Prix" type="number"
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input class="form-control input-sm" id="PROQTY" name="PROQTY" placeholder="Quantite" type="number"
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <button class="btn  btn-warning btn-sm" name="save" type="submit"><span class="fa fa-save fw-fa"></span>
                    Modifier</button>
            </div>
        </div>
    </div>
