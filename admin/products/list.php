...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Liste des produits <a href="index.php?view=add" class="btn btn-primary btn-xs  "> <i
                    class="fa fa-plus-circle fw-fa"></i> Nouveau</a> </h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<form action="controller.php?action=delete" Method="POST">
    <div class="table-responsive">
        ...
        <div class="btn-group">
            ...
            <button type="submit" class="btn btn-default" name="delete"><i class="fa fa-trash fw-fa"></i>
                Supprimer</button>
        </div>
    </div>
</form>
            ...
            <form action="<?php echo web_root; ?>admin/products/controller.php?action=photos"
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" type="button">Fermer</button> <button
                        class="btn btn-primary" name="savephoto" type="submit">Importer</button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
