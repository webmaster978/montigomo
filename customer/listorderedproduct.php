	        ...
	        <div class="modal-header">
				...
				WHERE   s.`CUSTOMERID`=c.`CUSTOMERID` and ORDEREDNUM=" . $_SESSION['ordernumber'];
		 		...
		 		<p>Items to be pickup : <?php
	                    ...
	                    <h5>DEAR Ma'am/Sir ,</h5>
	                    <h5>Your order is on its way! As you have ordered via Cash on Delivery, please have the exact
	                        amount of cash for our deliverer. </h5> -->
	                    <hr />
	                    <h4><strong>Montigomo</strong></h4>
	                    <div class="row">
	                        <div class="col-md-6">
	                            <p> FACTURE NUMERO : <?php echo $_SESSION['ordernumber']; ?></p>
						...
						?>
	                    <hr />
	                    <h4><strong>Information sur la vente</strong></h4>
				...
				WHERE   s.`CUSTOMERID`=c.`CUSTOMERID` and ORDEREDNUM=" . $_SESSION['ordernumber'];
	                    ...
	                    <div class="row">
	                        <div class="col-md-6 pull-left">
	                            ...
	                            <div>Mode de payement : <?php echo $cur->PAYMENTMETHOD; ?></div>
	                    ...
	                    <div class="row">
	                        ...
	                        <h4 style="text-align:center">les bien achetés sont ni echanger</h4>
	                    </div>
	                    <?php } ?>
	                </div>
	            ...
	            <div class="modal-footer">
	                <div id="divButtons" name="divButtons">
	                    ...
	                    <button onclick="tablePrint();" class="btn btn_fixnmix pull-right "><span
	                            class="glyphicon glyphicon-print"></span> IMPRIMER</button>

	                    <?php } ?>
	                    <button class="btn btn-pup" id="btnclose" data-dismiss="modal" type="button">Fermer</button>
	                </div>
