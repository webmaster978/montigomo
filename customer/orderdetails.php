        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 pull-right">
                    <div class="col-md-10 col-lg-12 col-sm-8">
                        ...
                        Vente numero :<?php echo $res->AUTO; ?>
                    </div>
                </div>
            </div>
            <div class="table-responsive cart_info">
                ...
                <table class="table table-condensed" id="table">
                    <thead>
                        <tr class="cart_menu">
                            <th style="width:12%; align:center; ">Produits</th>
                            <th>Description</th>
            ...
            ?>
                ...
                <div class="  pull-right">
                    <p align="right">
                    <div> Prix total : $ <span id="sum">0.00</span></div>
                    <!-- <div> Delivery Fee :  <span id="fee">0.00</span></div> -->
                    <div> Total : $ <span id="overall"><?php echo $tot; ?></span></div>
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" class="paymethod" name="paymethod" id="deliveryfee"
                                        ...
                                        data-parent="#accordion" data-target="#collapseOne">Cash
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="index.php?q=cart" class="btn btn-default pull-left"><span
                                class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Pannier</strong></a>
                    </div>
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-pup  pull-right " name="btn" id="btn"
                            onclick="return validatedate();" /> Soumettre <span
