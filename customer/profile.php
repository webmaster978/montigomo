            ...
            <div class="col-sm-3">
                <div class="panel">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item text-right"><span class="pull-left"><strong>Nom complet
                                </strong></span>
                            <?php echo $res->FNAME . ' ' . $res->LNAME; ?></li>
                        <li class="list-group-item text-right">
                            <div class="panel-group" id="accordion">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Modifier le mot
                                    de
                                    passe
                                </a>
                ...
                <div class="panel">
                    <div class="panel-body">
                        <ul class="nav nav-tabs" id="myTab">
                            <li class="active">
                                <a data-toggle="tab" href="#home">Liste des produits</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#settings">Modifier le compte
                                </a>
                            </li>
                            <!-- <li>
                                                    ...
                                                    <td class="tooltip-demo">
                                                        <a class="orderid btn btn-pup btn-xs"
                                                            ...
                                                            <i class="fa fa-info-circle fa-fw" data-placement="left"
                                                                ...
                                                                class="tooltip tooltip.top">voir</span></a>
