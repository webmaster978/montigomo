             ...
             <div class="modal-header">
                 ...
                 <div class="modal-body">
                     ...
                     <ul class="nav nav-pills">
                         <li class="active"><a class="btn btn-default check_out" href="#home"
                                 ...
                                 <div class="panel-body">
                                     ...
                                     <form class="form-horizontal span6" name="" action="login.php" method="POST">
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-10">
                                                 <label class="col-md-4 control-label" for="U_USERNAME">Username
                                                     :</label>
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-10">
                                                 <label class="col-md-4 control-label" for="U_PASS">Mot de passe
                                                     :</label>

                                                 <div class="col-md-8">
                                                     <input name="U_PASS" id="U_PASS" placeholder="Mot de passe"
                                             ...
                                             <div class="col-md-10">
                                                 ...
                                                 <div class="col-md-8">
                                                     <button type="submit" id="modalLogin" name="modalLogin"
                                                         class="btn btn-pup"><span
                                                             class="glyphicon glyphicon-log-in "></span> Se
                                                         connecter</button>
                         ...
                         <div class="tab-pane fade" id="profile">
                             ...
                             <form class="form-horizontal span6" action="customer/controller.php?action=add"
                                 ...
                                 <div class="panel panel-pup">
                                     ...
                                     <div class="panel-body">
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-10">
                                                 ...
                                                 <div class="col-md-8">
                                                     <p> I <input type="checkbox" id="conditionterms"
                                                             name="conditionterms" value="checkbox" />
                                                         <small>Agree with the <a class="toggle-modal"
                                                                 onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"><b>TERMS
                                                                     AND CONDITION</b></a> of Janobe Source
                                                             Code.</small>
                                     ...
                                     <div class="panel-footer">
                                         <p align="left">&copy; <a href="https://bit.ly/2LPn9Wu">Janobe Source Code</a>
                                         </p>
                                     </div>
                                 </div>
                                 <!-- end panel sign up -->
