                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +243 999 999 999</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> montigomo@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 clearfix">
                        <div class="shop-menu clearfix pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="<?php echo web_root; ?>index.php?q=cart"><i
                                            class="fa fa-shopping-cart"></i> Cart</a></li>
                                <?php if (isset($_SESSION['CUSID'])) { ?>
                                <li><a href="<?php echo web_root ?>index.php?q=profile"><i class="fa fa-user"></i> Mon
                                        compte</a></li>
                                <li><a href="<?php echo web_root ?>logout.php"><i class="fa fa-lock"></i>
                                        Deconnexion</a>
                                </li>
                                <?php } else { ?>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li><a href="<?php echo web_root; ?>" class="active">Acceuil</a></li>
                                <li class="dropdown"><a href="#">Magasin<i class="fa fa-angle-down"></i></a>
  ...
  ?>
    ...
    <footer id="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="col-sm-6">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <iframe class="iframe-img" src="https://www.youtube.com/embed/aMDC3Da4KIA"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen></iframe>
                                </a>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Modified by <span><a href="#">Janobe Source
                                Code</a></span></p>
